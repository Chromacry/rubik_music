...
public class AdapterPopular extends RecyclerView.Adapter<AdapterPopular.PhoneViewHold>  {

    ArrayList<SongData> popularLocations;
    final private ListItemClickListener mOnClickListener;

    public AdapterPopular(ArrayList<SongData> popularLocations, ListItemClickListener listener) {
...
//        holder.image.setImageResource(AdapterHelper.getImage());
    ...
    public interface ListItemClickListener {
        void onpopularListClick(int clickedItemIndex);
    }
    ...
    public class PhoneViewHold extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mOnClickListener.onpopularListClick(clickedPosition);
        }
    }
