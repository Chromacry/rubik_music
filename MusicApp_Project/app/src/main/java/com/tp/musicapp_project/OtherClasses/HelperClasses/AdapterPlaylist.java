...
public class AdapterPlaylist extends RecyclerView.Adapter<AdapterPlaylist.PhoneViewHold>  {

    ArrayList<SongPlaylistData> popularLocations;
    final private ListItemClickListener mOnClickListener;

    public AdapterPlaylist(ArrayList<SongPlaylistData> popularLocations, ListItemClickListener listener) {
...
//        holder.image.setImageResource(AdapterHelper.getImage());
    ...
    public interface ListItemClickListener {
        void onplaylistListClick(int clickedItemIndex);
    }
    ...
    public class PhoneViewHold extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mOnClickListener.onplaylistListClick(clickedPosition);
        }
    }
