...
public class AdapterRecommanded extends RecyclerView.Adapter<AdapterRecommanded.PhoneViewHold>  {

    ArrayList<SongData> popularLocations;
    final private ListItemClickListener mOnClickListener;

    public AdapterRecommanded(ArrayList<SongData> popularLocations, ListItemClickListener listener) {
    ...
    public PhoneViewHold onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recommandedcardtemplate, parent, false);
    ...
    public interface ListItemClickListener {
        void onrecommandedListClick(int clickedItemIndex);
    }
    ...
    public class PhoneViewHold extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mOnClickListener.onrecommandedListClick(clickedPosition);
        }
    }
